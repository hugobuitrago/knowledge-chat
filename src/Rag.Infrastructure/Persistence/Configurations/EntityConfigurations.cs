...
internal sealed class DocumentChunkConfiguration : IEntityTypeConfiguration<DocumentChunk>
{
    ...
    public void Configure(EntityTypeBuilder<DocumentChunk> builder)
    {
        ...
        builder.Property(entity => entity.StartOffset).HasColumnName("start_offset").IsRequired();
        builder.Property(entity => entity.EndOffset).HasColumnName("end_offset").IsRequired();
        builder.Property(entity => entity.ChunkingConfigurationHash)
            .HasColumnName("chunking_configuration_hash")
            .HasColumnType("character(64)")
            .IsRequired();
        ...
        builder.HasIndex(entity => new
        {
            entity.TenantId,
            entity.ContentHash,
            entity.ChunkingConfigurationHash,
        })
            .HasDatabaseName("ix_document_chunks_embedding_reuse");
