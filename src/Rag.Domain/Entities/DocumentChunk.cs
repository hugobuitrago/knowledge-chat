...
public sealed class DocumentChunk : CreatedEntity
{
    private DocumentChunk(
        ...
        int startOffset,
        int endOffset,
        string chunkingConfigurationHash,
        float[] embedding,
        string metadataJson)
        : base(id)
    {
        ...
        EndOffset = endOffset;
        ChunkingConfigurationHash = DomainGuard.Sha256(
            chunkingConfigurationHash,
            nameof(chunkingConfigurationHash));
    ...
    private DocumentChunk()
    {
        ...
        ChunkingConfigurationHash = string.Empty;
        Embedding = [];
        MetadataJson = "{}";
    }
    ...
    public string ChunkingConfigurationHash { get; private set; }
